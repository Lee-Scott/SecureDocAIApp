...
const schema = z.object({
  ...
  password: z.string().min(4, 'Password is required').optional(),
});
...
const Register = () => {
  ...
  const isFieldValid = (field: keyof IRegisterRequest): boolean =>
    getFieldState(field, formState).isTouched &&
    !getFieldState(field, formState).invalid;
